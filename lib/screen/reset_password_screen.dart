    ...
    if (step == 1) {
      ...
      try {
        final response = await dio.post(
          'https://a117-210-94-220-228.ngrok-free.app/api/send_verification_code/',
          data: {'email': email},
        );
      ...
      try {
        final response = await dio.post(
          'https://a117-210-94-220-228.ngrok-free.app/api/verify_code/',
          data: {
            'email': email,
            'code': code,
          },
      ...
      try {
        final response = await dio.post(
          'https://a117-210-94-220-228.ngrok-free.app/api/reset_password/',
          data: {
            'email': email,
            'code': code,
